...
$queryAlternatif = "SELECT siswa.nama as nama, GROUP_CONCAT(alternatif.nilai) as nilai FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 1' GROUP BY siswa.id";
  ...
  <section class="content">
    ...
    <?php if($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'super admin'): ?>
        ...
        <select name="kelas" id="kelas" onchange="location = this.value;">
          <option value="<?= base_url('hasil/hasil-1.php'); ?>" selected>Kelas 1</option>
