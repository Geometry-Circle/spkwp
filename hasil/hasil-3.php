...
$queryAlternatif = "SELECT siswa.nama as nama, GROUP_CONCAT(alternatif.nilai) as nilai FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 3' GROUP BY siswa.id";
      ...
      <div class="header-text">
        <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'super admin') : ?>
          ...
          <select name="kelas" id="kelas" onchange="location = this.value;">
            ...
            <option value="<?= base_url('hasil/hasil-3.php'); ?>" selected>Kelas 3</option>
