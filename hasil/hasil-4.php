...
$queryAlternatif = "SELECT siswa.nama as nama, GROUP_CONCAT(alternatif.nilai) as nilai FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 4' GROUP BY siswa.id";
...
// mengekstrak nilai alternatif ke dalam array siswa
$siswa = [];
      ...
      <div class="header-text">
        <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'super admin') : ?>
          ...
          <select name="kelas" id="kelas" onchange="location = this.value;">
            ...
            <option value="<?= base_url('hasil/hasil-4.php'); ?>" selected>Kelas 4</option>
