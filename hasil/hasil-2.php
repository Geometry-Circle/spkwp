...
$queryAlternatif = "SELECT siswa.nama as nama, GROUP_CONCAT(alternatif.nilai) as nilai FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 2' GROUP BY siswa.id";
