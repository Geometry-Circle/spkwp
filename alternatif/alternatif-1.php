...
$no = 1;
$query = "SELECT siswa.id, siswa.nama, GROUP_CONCAT(alternatif.nilai) FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 1' GROUP BY siswa.id";
    ...
    <main>
      ...
      <div>
        ...
        <select name="kelas" id="kelas" onchange="location = this.value;">
          <option value="<?= base_url('alternatif/alternatif-1.php'); ?>" selected>Kelas 1</option>
      ...
      <div class="flex">
        ...
        <!-- Button Tambah -->
        <a href="tambah-alternatif.php?kelas=1" class="btn2 btn-tambah">
              ...
              foreach ($data as $key => $value) : ?>
                <tr>
                  ...
                  <td class="aksi">
                    <div class="buttons">
                      <!-- Button Edit -->
                      <a href="<?= base_url("alternatif/edit-alternatif.php?id=$value[0]&kelas=1"); ?>" class="btn-a btn-edit btn-sm">
                      ...
                      <!-- Button Hapus -->
                      <a href="<?= base_url("alternatif/delete.php?id=$value[0]&page=1"); ?>" class="btn-a btn-hapus btn-sm">
