...
$no = 1;
$query = "SELECT siswa.id, siswa.nama, GROUP_CONCAT(alternatif.nilai) FROM alternatif JOIN siswa ON (siswa.id= alternatif.id_siswa) WHERE siswa.kelas = 'Kelas 3' GROUP BY siswa.id";
    ...
    <main>
      ...
      <!-- <div>
        ...
        <select name="kelas" id="kelas" onchange="location = this.value;">
          ...
          <option value="<?= base_url('alternatif/alternatif-3.php'); ?>" selected>Kelas 3</option>
