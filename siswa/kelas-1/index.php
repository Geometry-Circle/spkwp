...
$no = 1;
$query = "SELECT * FROM siswa WHERE kelas = 'Kelas 1'";
    ...
    <section class="content">
        <main>
            ...
            <div class="flex">
                ...
                <!-- Button Tambah -->
                <a href="../tambah-siswa.php?req=1" class="btn2 btn-tambah">
                                ...
                                foreach ($data as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <div class="buttons">
                                                <!-- Button Edit -->
                                                <a href="../edit-siswa.php?id=<?= $value['id']; ?>&req=1" class="btn-a btn-edit btn-sm">
                                                ...
                                                <!-- Button Hapus -->
                                                <a href="../delete.php?id=<?= $value['id']; ?>&req=1" class="btn-a btn-hapus btn-sm">
