...
$no = 1;
$query = "SELECT * FROM siswa WHERE kelas = 'Kelas 3'";
...
<head>
    ...
    <title>Alternatif | Siswa Kelas 3</title>
</head>
    ...
    <section class="content">
        <main>
            ...
            <div class="flex">
                ...
                <!-- Button Tambah -->
                <a href="../tambah-siswa.php?req=3" class="btn2 btn-tambah">
                                ...
                                foreach ($data as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <div class="buttons">
                                                <!-- Button Edit -->
                                                <a href="../edit-siswa.php?id=<?= $value['id']; ?>&req=3" class="btn-a btn-edit btn-sm">
                                                ...
                                                <!-- Button Hapus -->
                                                <a href="../delete.php?id=<?= $value['id']; ?>&req=3" class="btn-a btn-hapus btn-sm">
