...
$no = 1;
$query = "SELECT * FROM siswa WHERE kelas = 'Kelas 4'";
...
<head>
    ...
    <title>Alternatif | Siswa Kelas 4</title>
</head>
...
<body>
    <section class="content">
        <main>
            ...
            <?php if ($_SESSION['level'] == 'admin') : ?>
                <div>
                    ...
                    <select name="kelas" id="kelas" onchange="location = this.value;">
                        ...
                        <option value="<?= base_url('siswa/kelas-4/index.php'); ?>" selected>Kelas 4</option>
            ...
            <?php endif; ?>
            <div class="flex">
                <h2>Data Siswa Kelas 4</h2>

                <!-- Button Tambah -->
                <a href="../tambah-siswa.php?req=4" class="btn2 btn-tambah">
                ...
                <!-- Button Tambah Excel -->
                <a href="../tambah-excel.php?req=4" class="btn2 btn-tambah-excel">
                    <span class="btn-text">
                        Tambah Excel
                    </span>
                </a>
                                ...
                                foreach ($data as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <div class="buttons">
                                                <!-- Button Edit -->
                                                <a href="../edit-siswa.php?id=<?= $value['id']; ?>&req=4" class="btn-a btn-edit btn-sm">
                                                ...
                                                <!-- Button Hapus -->
                                                <a href="../delete.php?id=<?= $value['id']; ?>&req=4" class="btn-a btn-hapus btn-sm">
