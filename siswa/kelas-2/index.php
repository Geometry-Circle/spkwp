...
$no = 1;
$query = "SELECT * FROM siswa WHERE kelas = 'Kelas 2'";
...
<head>
    ...
    <title>Alternatif | Siswa Kelas 2</title>
</head>
            ...
            <?php if ($_SESSION['level'] == 'admin') : ?>
                <div>
                    ...
                    <select name="kelas" id="kelas" onchange="location = this.value;">
                        ...
                        <option value="<?= base_url('siswa/kelas-2/index.php'); ?>" selected>Kelas 2</option>
                        <option value="<?= base_url('siswa/kelas-3/index.php'); ?>">Kelas 3</option>
                        <option value="kelas-4/index.php">Kelas 4</option>
                        <option value="kelas-5/index.php">Kelas 5</option>
                        <option value="kelas-6/index.php">Kelas 6</option>
                    </select>
                </div>
            <?php endif; ?>
            <div class="flex">
                <h2>Data Siswa Kelas 2</h2>

                <!-- Button Tambah -->
                <a href="../tambah-siswa.php?req=2" class="btn2 btn-tambah">
                ...
                <!-- Button Tambah Excel -->
                <a href="../tambah-excel.php?req=2" class="btn2 btn-tambah-excel">
                    <span class="btn-text">
                        Tambah Excel
                    </span>
                </a>
                                ...
                                foreach ($data as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <div class="buttons">
                                                <!-- Button Edit -->
                                                <a href="../edit-siswa.php?id=<?= $value['id']; ?>&req=2" class="btn-a btn-edit btn-sm">
                                                ...
                                                <!-- Button Hapus -->
                                                <a href="../delete.php?id=<?= $value['id']; ?>&req=2" class="btn-a btn-hapus btn-sm">
