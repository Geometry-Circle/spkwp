...
let btnHapusSemua = document.getElementById("btn-hapus-semua");
btnHapusSemua.addEventListener("click", function () {
  alertify
    .confirm("Apakah anda yakin ingin menghapus semua data ?", function () {
      window.location.href = "http://localhost/wp/siswa/hapus_semua";
    })
    .set("movable", false);
});
